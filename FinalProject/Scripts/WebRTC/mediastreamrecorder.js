...
function MediaStreamRecorder(mediaStream) {
    ...
    this.save = function(file, fileName) {
        if (!file) {
            ...
            ConcatenateBlobs(mediaRecorder.blobs,
        ...
        mediaRecorder.onerror = function(error) {
            if (!self.disableLogs) {
                if (error.name === "InvalidState") {
                    ...
                    console
                        .error("The UA cannot provide the codec or recording option that has been requested.", error);
                } else {
...
var Whammy = (function() {
    ...
    function whammyInWebWorker(frames) {
        ...
        function getStrLength(string, offset) {
            return parseInt(string.substr(offset + 4, 4)
                .split("")
                .map(function(i) {
