        ...
        1: [
            function(require, module, exports) {
                ...
                SDPUtils.matchPrefix = function(blob, prefix) {
                    return SDPUtils.splitLines(blob)
                ...
                SDPUtils.parseRtpParameters = function(mediaSection) {
                    ...
                    SDPUtils.matchPrefix(mediaSection, "a=extmap:")
                        ...
                        window.RTCPeerConnection = function(pcConfig, pcConstraints) {
                            ...
                            pc.getStats = function(selector, successCallback, errorCallback) {
                                ...
                                var makeMapStats = function(stats, legacyStats) {
                                    var map = new Map(Object.keys(stats)
                                        .map(function(key) {
                                            return [key, stats[key]];
                                        }));
                                    legacyStats = legacyStats || stats;
                                    Object.keys(legacyStats)
                ...
                module.exports = function() {
                                    ...
                                    return navigator.mediaDevices.enumerateDevices()
                                        .then(function(devices) {
                                            ...
                                            if (back) {
                                                constraints.video
                                                    .deviceId =
                                                    face.exact ? { exact: back.deviceId } : { ideal: back.deviceId };
                                            }
                    ...
                    var getUserMedia_ = function(constraints, onSuccess, onError) {
                        shimConstraints_(constraints,
                            function(c) {
                                navigator.webkitGetUserMedia(c,
                                    onSuccess,
                                    function(e) {
                ...
                var edgeShim = {
                    shimPeerConnection: function() {
                                    ...
                                    sections.forEach(function(mediaSection, sdpMLineIndex) {
                                        ...
                                        if (!rejected) {
                                            ...
                                            if (!self.usingBundle || sdpMLineIndex === 0) {
                                                iceTransport.start(iceGatherer,
                                                    remoteIceParameters,
                        ...
                        window.RTCPeerConnection.prototype.createAnswer = function() {
                            ...
                            if (this.usingBundle) {
                                sdp += "a=group:BUNDLE " +
                                    this.transceivers.map(function(t) {
                                        return t.mid;
                                    })
                                    .join(" ") +
                                    "\r\n";
                        ...
                        window.RTCPeerConnection.prototype.addIceCandidate = function(candidate) {
                            if (candidate === null) {
                                ...
                                if (transceiver) {
                                    ...
                                    sections[mLineIndex + 1] += (cand.type
                ...
                var utils = {
                    disableLog: function(bool) {
                        if (typeof bool !== "boolean") {
                            return new Error("Argument type: " +
                                typeof bool +
