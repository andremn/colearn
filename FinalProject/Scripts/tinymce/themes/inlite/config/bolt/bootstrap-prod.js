    ...
    function(fn) {
        var create = function(loader, pather, namespace, path, idTransformer, options) {
            ...
            var get = function(id) {
                ...
                var after = options !== undefined && options.fresh === true
