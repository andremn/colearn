    ...
    function(Tools, Factory, Promise, Actions, UrlType) {
        ...
        var createQuickLinkForm = function(editor, hide) {
            ...
            return createForm("quicklink",
            {
                ...
                onsubmit: function(e) {
                    convertLinkToAbsolute(editor, e.data.linkurl)
                        .then(function(url) {
        ...
        return function() {
            ...
            var showPanelAt = function(panel, id, editor, targetRect) {
                ...
                if (result) {
                    ...
                    movePanelTo(panel,
                        Layout.userConstrain(userConstainHandler, targetRect, contentAreaRect, panelRect));
...
define("tinymce/inlite/Theme",
    ...
    function(ThemeManager,
        ...
        var bindContextualToolbarsEvents = function(editor, panel) {
            ...
            var throttledTogglePanelWhenNotInForm = Delay
                .throttle(ignoreWhenFormIsVisible(panel, togglePanel(editor, panel)), 0);
