asynctest("browser/core/ThemeTest",
    ...
    function(TinyLoader,
        ...
        [
            UiFinder.cWaitForState("window element",
                ".mce-window",
                function() {
                    return true;
                })
        ...
        var sLinkTests = function(tinyApis) {
            ...
            var sLinkWithConfirmOkTest = function(inputHtml, spath, soffset, fpath, foffset, url, expectedHtml) {
                return sContentActionTest(inputHtml,
                    spath,
                    soffset,
                    fpath,
                    foffset,
            ...
            return GeneralSteps.sequence([
                ...
                sLinkWithConfirmCancelTest("<p>a</p>",
                    [0, 0],
                    0,
                    [0, 0],
                    1,
                ...
                sLinkTest('<p><a id="x" href="#1">a</a></p>',
                    [0, 0, 0],
                    0,
                    [0, 0, 0],
                    1,
